    ...
    const hendleRegister = () => {
        ...
        return (<div className='flex flex-col gap-10'>
            ...
            <p className='text-white'>{t("form.pathOne")}</p>
                <button type="button" onClick={hendleRegister} className="font-bold  text-red-800 underline hover:text-white transition-all duration-300">{t("form.pathTwo")}</button>
                </div>
        </div>)
}
